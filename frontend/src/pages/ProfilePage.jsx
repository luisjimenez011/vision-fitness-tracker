...
const METRIC_FILTERS = [
  // 💡 NOTA: Los colores aquí no se usarán directamente en el Select, pero son útiles para la gráfica
...
function ProfilePage() {
  ...
  // Efecto 1 y 2: Lógica de fetch (Mantenida intacta)
  useEffect(() => {
    // ... fetchData logic ...
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Grid container spacing={3} sx={{ mb: 5 }}>
        ...
        {/* Espacio para otra estadística clave */}
        <Grid item xs={12} sm={12} md={4}>
            <StatCard 
                title="Mejor Marca Personal" 
                value={stats.personalBest || 'N/A'} 
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                        <Box sx={{ bgcolor: 'background.default', p: 2, borderRadius: 2 }}>
                            ...
                            <MuscleBalanceChart
                                data={muscleVolume}
                                // title se pasa en la propia gráfica para mejor control de estilos
                            />
                        </Box>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6}>
                        <Box 
                            sx={{ 
                                bgcolor: 'background.default', // Negro profundo para el bloque de IA
                                p: 2, 
                                borderRadius: 2, 
                                minHeight: { xs: 200, md: 340 }, // Ajuste de altura
                                display: 'flex', 
