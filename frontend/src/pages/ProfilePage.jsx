...
                // 2. Obtener Mapa Corporal y Análisis de IA
...
                
                // CORRECCIÓN CRÍTICA: Mapeo y ajuste de datos para Recharts
...
            <div style={{ display: 'flex', justifyContent: 'space-around', margin: '20px 0', backgroundColor: '#f0f0f0', color: '#333', padding: '15px', borderRadius: '10px' }}>
...
            <div style={{ marginBottom: '40px', border: '1px solid #ddd', padding: '20px', borderRadius: '10px', backgroundColor: '#fff' }}>
                <h2>🔥 Top 5 Ejercicios</h2>
                <ul style={{ listStyleType: 'none', padding: 0 }}>
                    {topExercises.map(([name, count], index) => (
                        <li key={name} style={{ margin: '8px 0', borderBottom: '1px dotted #eee', paddingBottom: '5px' }}>
...
            </div>
            
            {/* C. MAPA CORPORAL Y ANÁLISIS DE IA */}
            <div style={{ display: 'flex', gap: '20px', marginBottom: '40px', alignItems: 'stretch' }}>
                <div style={{ flex: 1, border: '1px solid #ddd', padding: '20px', borderRadius: '10px', backgroundColor: '#fff' }}>
